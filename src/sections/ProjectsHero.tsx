      ...
      <div className="container">
        <div className="flex flex-col items-center">
          <div className="bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg">
            ...
            <div className="text-sm font-medium">AI & Innovation</div>
          </div>
        </div>
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Featured <span className="underlined">Projects</span></h1>
          <p className="mt-4 text-center text-white/60 md:text-lg">
            Exploring the intersection of AI, agriculture, and sustainable technology solutions for Africa
          </p>
        </div>
